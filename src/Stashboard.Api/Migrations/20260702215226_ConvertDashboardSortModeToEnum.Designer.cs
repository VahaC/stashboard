...
namespace Stashboard.Api.Migrations
{
    ...
    [Migration("20260702215226_ConvertDashboardSortModeToEnum")]
    partial class ConvertDashboardSortModeToEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stashboard.Api.Data.MqttSettingsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<bool>("AllowUntrustedTls")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Stashboard.Api.Data.ProxmoxRestoreSettingsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ProxmoxRestoreSettings");
                });
            ...
            modelBuilder.Entity("Stashboard.Api.Data.TwoFactorRecoveryCodeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.ComposeChangeAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ChangedServices")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("DockerConnectionId", "ChangedUtc");

                    b.HasIndex("InitiatedByUserId", "ChangedUtc");

                    b.ToTable("ComposeChangeAudits");
                });

            modelBuilder.Entity("Stashboard.Core.Entities.ContainerIconEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("UserId", "DockerConnectionId", "ContainerName")
                        .IsUnique();

                    b.ToTable("ContainerIcons");
                });

            modelBuilder.Entity("Stashboard.Core.Entities.ContainerProxmoxLinkEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ContainerProxmoxLinks");
                });
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.ProxmoxConfigAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.ProxmoxRestoreAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<string>("BackupVolid")
                        .HasMaxLength(512)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ProxmoxRestoreAudits");
                });
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.StatusPageEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.StatusPageItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("StatusPageId", "WebResourceId")
                        .IsUnique();

                    b.ToTable("StatusPageItems");
                });
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.WebResourceProxmoxGuestLinkEntity", b =>
                {
                    ...
                    b.HasIndex("WebResourceId", "ProxmoxConnectionId", "VmId")
                        .IsUnique();

                    b.ToTable("WebResourceProxmoxGuestLinks");
                });
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.StatusPageItemEntity", b =>
                {
                    b.HasOne("Stashboard.Core.Entities.StatusPageEntity", "StatusPage")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Stashboard.Core.Entities.WebResourceEntity", b =>
                {
                    ...
                    b.Navigation("ProxmoxGuestLinks");
